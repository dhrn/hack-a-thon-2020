...
The versioning of the Helm Chart is based on [SemVer](https://semver.org/) as it is [supported by Helm](https://docs.helm.sh/developing_charts/#charts-and-versioning). There are a few ACS specific extensions to the rules. Please refer to [Helm versioning guide](../../acs-deployment/docs/helm-versioning.md).

Stable charts are published in [stable repository](http://kubernetes-charts.alfresco.com/stable). Once a stable chart is published, an entry will be added to [releases table](../../acs-deployment/docs/helm-chart-releases.md).
...
![Helm Deployment Components](../../acs-deployment/docs/diagrams/helm-chart/helm-components.png)
